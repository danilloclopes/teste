...
import RollingAnchor from "./RollingAnchor";
			...
			<nav className={`navbar${scrolled ? " scrolled" : ""}`}>
				<div className="container navbar-inner">
					...
					<nav className="nav-links">
                        <RollingAnchor
                            reference={"#como-funciona"}
                            functionText={"como-funciona"}
                            text={"Como Funciona"}
                        />
                        <RollingAnchor
                            reference={"#personagens"}
                            functionText={"personagens"}
                            text={"Personagens"}
                        />
                        <RollingAnchor
                            reference={"#diferenciais"}
                            functionText={"diferenciais"}
                            text={"Diferenciais"}
                        />
                        <RollingAnchor
                            reference={"#depoimentos"}
                            functionText={"depoimentos"}
                            text={"Depoimentos"}
                        />
					</nav>
